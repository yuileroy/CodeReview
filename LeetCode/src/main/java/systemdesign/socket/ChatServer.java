 ...
 *
 * This is just a teaching example so it can be enhanced in many ways, e.g., better logging. Another is to accept a lot
 * of fun commands, like Slack.
 */
public class ChatServer {
    ...
    private static class Handler implements Runnable {
         ...
         * Remember the constructor is called from the server's main method, so this has to be as short as possible.
         */
